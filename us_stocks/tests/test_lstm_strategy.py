...
from us_invest_ai.lstm_strategy import (
    LSTMModelConfig,
    fit_lstm_model,
    generate_lstm_target_weights,
    predict_lstm_model,
)


class LSTMStrategyTests(unittest.TestCase):
    def test_fit_lstm_model_learns_simple_sequence_relationship(self) -> None:
    ...
    def test_generate_lstm_target_weights_prefers_stronger_trend_asset(self) -> None:
        ...
        weights, history = generate_lstm_target_weights(
            features=features,
