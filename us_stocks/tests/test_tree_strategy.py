...
class TreeStrategyTests(unittest.TestCase):
    def test_generate_tree_target_weights_prefers_stronger_trend_asset(self) -> None:
        ...
        weights, history = generate_tree_target_weights(
            features=features,
